...
export const Hero = React.memo(() => {
  return (
    <header className="min-h-screen flex items-start justify-center px-4 mt-14 md:mt-8 lg:mt-0 mx-auto lg:mx-24 pt-28 lg:pt-36 lg:px-8">
      <div className="max-w-7xl w-full mx-auto grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 text-left">
        <div className="text-center lg:text-left flex items-center animate-fade-down">
          <div className="space-y-6">
            ...
            <p className="text-lg text-muted-foreground max-w-xl mx-auto lg:mx-0 text-center lg:text-right">
